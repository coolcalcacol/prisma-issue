...
export class PrismaClient<
   ...
   * `prisma.error`: Exposes CRUD operations for the **Error** model.
    ...
    * ```
    */
  get error(): Prisma.ErrorDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type ErrorAggregateArgs = {
    /**
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<ErrorOrderByWithRelationInput>
    /**
  ...
  export type ErrorGroupByArgs = {
    where?: ErrorWhereInput
    orderBy?: Enumerable<ErrorOrderByWithAggregationInput>
    by: Array<ErrorScalarFieldEnum>
  ...
  type GetErrorGroupByPayload<T extends ErrorGroupByArgs> = Promise<
    Array<
      PickArray<ErrorGroupByOutputType, T['by']> & 
        {
  ...
  export type ErrorSelect = {
    id?: boolean
  }

  export type ErrorGetPayload<
    S extends boolean | null | undefined | ErrorArgs,
    U = keyof S
      > = S extends true
        ? Error
    : S extends undefined
    ? never
    : S extends ErrorArgs | ErrorFindManyArgs
    ?'include' extends U
    ? Error 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof Error ?Error [P]
  : 
     never
  } 
    : Error
  ...
  type ErrorCountArgs = Merge<
    Omit<ErrorFindManyArgs, 'select' | 'include'> & {
      select?: ErrorCountAggregateInputType | true
    }
  >

  export interface ErrorDelegate<GlobalRejectSettings> {
    /**
     ...
     * })
    **/
    findUnique<T extends ErrorFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, ErrorFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Error'> extends True ? CheckSelect<T, Prisma__ErrorClient<Error>, Prisma__ErrorClient<ErrorGetPayload<T>>> : CheckSelect<T, Prisma__ErrorClient<Error | null >, Prisma__ErrorClient<ErrorGetPayload<T> | null >>
     ...
     * })
    **/
    findFirst<T extends ErrorFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, ErrorFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Error'> extends True ? CheckSelect<T, Prisma__ErrorClient<Error>, Prisma__ErrorClient<ErrorGetPayload<T>>> : CheckSelect<T, Prisma__ErrorClient<Error | null >, Prisma__ErrorClient<ErrorGetPayload<T> | null >>
     ...
     * 
    **/
    findMany<T extends ErrorFindManyArgs>(
      args?: SelectSubset<T, ErrorFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<Error>>, PrismaPromise<Array<ErrorGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends ErrorCreateArgs>(
      args: SelectSubset<T, ErrorCreateArgs>
    ): CheckSelect<T, Prisma__ErrorClient<Error>, Prisma__ErrorClient<ErrorGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends ErrorCreateManyArgs>(
      args?: SelectSubset<T, ErrorCreateManyArgs>
     ...
     * 
    **/
    delete<T extends ErrorDeleteArgs>(
      args: SelectSubset<T, ErrorDeleteArgs>
    ): CheckSelect<T, Prisma__ErrorClient<Error>, Prisma__ErrorClient<ErrorGetPayload<T>>>
     ...
     * 
    **/
    update<T extends ErrorUpdateArgs>(
      args: SelectSubset<T, ErrorUpdateArgs>
    ): CheckSelect<T, Prisma__ErrorClient<Error>, Prisma__ErrorClient<ErrorGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends ErrorDeleteManyArgs>(
      args?: SelectSubset<T, ErrorDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends ErrorUpdateManyArgs>(
      args: SelectSubset<T, ErrorUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends ErrorUpsertArgs>(
      args: SelectSubset<T, ErrorUpsertArgs>
    ): CheckSelect<T, Prisma__ErrorClient<Error>, Prisma__ErrorClient<ErrorGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends ErrorAggregateArgs>(args: Subset<T, ErrorAggregateArgs>): PrismaPromise<GetErrorAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, ErrorGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetErrorGroupByPayload<T> : Promise<InputErrors>
  }
   ...
   */
  export class Prisma__ErrorClient<T> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   * Error findUnique
   */
  export type ErrorFindUniqueArgs = {
    /**
     * Select specific fields to fetch from the Error
     * 
    **/
    select?: ErrorSelect | null
    /**
     * Throw an Error if a Error can't be found
     * 
    **/
   ...
   * Error findFirst
   */
  export type ErrorFindFirstArgs = {
    /**
     * Select specific fields to fetch from the Error
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<ErrorScalarFieldEnum>
  }
   ...
   * Error createMany
   */
  export type ErrorCreateManyArgs = {
    data: Enumerable<ErrorCreateManyInput>
   ...
   * Error updateMany
   */
  export type ErrorUpdateManyArgs = {
   ...
   * Error deleteMany
   */
  export type ErrorDeleteManyArgs = {
    where?: ErrorWhereInput
  }
  ...
  export type ErrorWhereInput = {
    AND?: Enumerable<ErrorWhereInput>
    OR?: Enumerable<ErrorWhereInput>
    NOT?: Enumerable<ErrorWhereInput>
  ...
  export type ErrorWhereUniqueInput = {
    id?: string
  }
  ...
  export type ErrorScalarWhereWithAggregatesInput = {
    AND?: Enumerable<ErrorScalarWhereWithAggregatesInput>
    OR?: Enumerable<ErrorScalarWhereWithAggregatesInput>
    NOT?: Enumerable<ErrorScalarWhereWithAggregatesInput>
